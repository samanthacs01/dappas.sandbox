...
const DEFAULT_TEXTURES: Record<string, string> = {
  ...
  'white-paper': typeof whitePaperTexture === 'string' ? whitePaperTexture : whitePaperTexture.src,
};
...
const Box3DModel: React.FC<Box3DModelProps> = ({ onLoadingChange }) => {
...
export default React.memo(Box3DModel);
