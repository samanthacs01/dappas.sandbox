...
func init() {
	goose.AddMigrationContext(upUpdateKpiFunctions, downUpdateKpiFunctions)
}

func upUpdateKpiFunctions(ctx context.Context, tx *sql.Tx) error {
...
func downUpdateKpiFunctions(ctx context.Context, tx *sql.Tx) error {
