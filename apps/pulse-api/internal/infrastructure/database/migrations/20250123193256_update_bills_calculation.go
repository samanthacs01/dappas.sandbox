...
func init() {
	goose.AddMigrationContext(upUpdateBillsCalculation, downUpdateBillsCalculation)
}

func upUpdateBillsCalculation(ctx context.Context, tx *sql.Tx) error {
...
func downUpdateBillsCalculation(ctx context.Context, tx *sql.Tx) error {
